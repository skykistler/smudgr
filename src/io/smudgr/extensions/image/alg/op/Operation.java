...
public abstract class Operation extends AlgorithmComponent {
	...
	/**
	 * Implementations of the {@link Operation#execute(PixelFrame)} method
	 * create a visual manipulation using the given
	 * {@link io.smudgr.util.PixelFrame}. Implementors are currently
	 * responsible for only acting on the parent {@link Algorithm} set of
	 * selected pixels.
	 * <p>
	 * While copies of the given {@link PixelFrame} may be created for
	 * computational purposes, the resulting frame should be stored in the
	 * {@link PixelFrame} instance passed into this method.
	 *
	 * @param img
	 *            {@link PixelFrame}
