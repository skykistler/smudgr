...
public class GifOutput implements Output {
	 ...
	 */
	public GifOutput(ImageOutputStream outputStream, int imageType, int timeBetweenFramesMS, boolean loopContinuously) throws IIOException, IOException {
	...
	public static void main(String[] args) throws Exception {
		if (args.length > 1) {
			...
			GifOutput writer = new GifOutput(output, firstImage.getType(), 1, false);
