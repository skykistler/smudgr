...
public class GifOut {
	 ...
	 */
	public GifOut(ImageOutputStream outputStream, int imageType, int timeBetweenFramesMS, boolean loopContinuously) throws IIOException, IOException {
	...
	public static void main(String[] args) throws Exception {
		if (args.length > 1) {
			...
			GifOut writer = new GifOut(output, firstImage.getType(), 1, false);
